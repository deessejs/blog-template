...
- [Vercel deploy](project/deploy.md) — per-app Vercel projects for web/app, dashboard overrides trump vercel.json, engines.node >=22.0.0 + cache-bust quirk
...
- [Single-tenant only](project/single-tenant.md) — NO organization plugin/schema/useActiveOrganization/#9710 workaround in this repo (re-confirmed 2026-07-28)
...
- [P1 sendOnSignUp — RESOLVED 2026-07-28 code](project/p1-send-on-signup-disabled.md) — sendOnSignUp is true + proxy gates unverified
